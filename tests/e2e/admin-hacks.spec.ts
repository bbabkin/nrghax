...
test.describe('Admin Hack Management', () => {
  ...
  test('admin should access hack management page', async ({ page }) => {
    await page.goto('/admin/hacks')
    await expect(page.getByRole('heading', { name: 'Manage Hacks' })).toBeVisible()
    await expect(page.getByRole('button', { name: /Create New Hack/i })).toBeVisible()
  })
  ...
  test('admin should create a new hack with content', async ({ page }) => {
    ...
    // Should redirect to admin hacks page
  ...
  test('admin should edit an existing hack', async ({ page }) => {
    ...
    // Should redirect back to admin hacks
    await page.waitForURL('**/admin/hacks', { timeout: 10000 })
  ...
  test('admin should delete a hack', async ({ page }) => {
    ...
    // Should redirect to admin hacks
    await page.waitForURL('**/admin/hacks', { timeout: 10000 })
